...
$page = [
    'title' => 'About Us At PianoDepot.com',
    'description' => 'PianoDepot.com about us and who we are and products we sell and services we offer..',
    'extra_css' => [
...
<script type="text/javascript"></script>
                <div class="gf_browser_unknown gform_wrapper gform_legacy_markup_wrapper gform-theme--no-framework" data-form-theme="legacy" data-form-index="0" id="gform_wrapper_1"><form method="post" enctype="multipart/form-data" id="gform_1" action="/about-us/" data-formid="1">
