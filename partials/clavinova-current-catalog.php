...
$clavinova_series = [
	'CLP Series' => [
		...
		'models' => [
			['CLP-825', '2,249.99', 'clp-825.jpg', 'GrandTouch-S action, 10 voices, and a compact console cabinet.'],
			['CLP-835', '3,299.99', 'clp-835.jpg', 'GrandTouch-S action, LCD display, 38 voices, and expanded lesson features.'],
			['CLP-845', '4,299.99', 'clp-845.jpg', 'Wooden GrandTouch-S keys and a powerful two-way speaker system.'],
			['CLP-865GP', '6,799.99', 'clp-865gp.jpg', 'Grand-style cabinet with GrandTouch-S action and immersive sound.'],
			['CLP-875', '5,699.99', 'clp-875.jpg', 'GrandTouch wooden-key action and three-way speaker system.'],
			['CLP-885', '7,499.99', 'clp-885.jpg', 'Counterweighted GrandTouch action and flagship upright sound system.'],
			['CLP-895GP', '9,499.99', 'clp-895gp.jpg', 'Flagship grand cabinet, counterweighted action, and Grand Acoustic Imaging.'],
		],
	],
	'CSP Series' => [
		...
		'models' => [
			['CSP-255', '4,199.99', 'csp-255.jpg', 'GrandTouch-S action, Stream Lights, accompaniment styles, and microphone input.'],
			['CSP-275', '5,799.99', 'csp-275.jpg', 'Wooden GrandTouch-S keys with a more powerful speaker system.'],
			['CSP-295', '8,199.99', 'csp-295.jpg', 'GrandTouch action, expanded voices, and premium three-way sound.'],
			['CSP-295GP', '11,799.99', 'csp-295gp.jpg', 'The flagship CSP experience in an elegant grand-style cabinet.'],
		],
	],
	'CVP Series' => [
		...
		'models' => [
			['CVP-905', '8,999.99', 'cvp-905.jpg', 'GrandTouch action, 7-inch touchscreen, guide lamps, and 525 accompaniment styles.'],
			['CVP-909', '14,199.99', 'cvp-909.jpg', 'Flagship upright CVP with a 9-inch touchscreen and premium sound system.'],
			['CVP-909GP', '19,999.99', 'cvp-909gp.jpg', 'Flagship CVP technology and sound in a grand-style cabinet.'],
		],
	],
];
?>
