...
$landing = [
	...
	'cards' => [
		...
		['label' => 'Special Occasions', 'title' => 'Piano Rental Service', 'description' => 'Explore short-term rentals of used grand pianos, used upright pianos, and select available digital pianos for special occasions.', 'href' => '/piano-rental-service/', 'action' => 'Explore piano rentals'],
	],
...
<script type="text/javascript"></script>
                <div class="gf_browser_unknown gform_wrapper gform_legacy_markup_wrapper gform-theme--no-framework" data-form-theme="legacy" data-form-index="0" id="gform_wrapper_1"><form method="post" enctype="multipart/form-data" id="gform_1" action="/services-we-offer/" data-formid="1">
